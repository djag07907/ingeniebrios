...
from basescerbeus.views import SinPrivilegios
...
# @permission_required('inv.change_marca', login_url= 'basescerbeus:sin_privilegios')
...
class UMNew(LoginRequiredMixin, generic.CreateView):
    ...
    context_object_name = 'obj'
    form_class = UMForm
    success_url = reverse_lazy("inv:um_list.html")
    login_url = 'basescerbeus:login'
